...
def setup_scene(model_path, fps_target):
    ...
    if 'Cube' in bpy.data.objects:
        #bpy.data.objects['Cube'].select_set(True) PATRICK
...
def process_poses(
    ...
    pkl_path='frankmocap-main/mocap_output/mocap/'
...
def export_animated_mesh(output_path):
    ...
    bpy.data.objects['Armature'].select
    bpy.data.objects['Armature'].children[0].select
